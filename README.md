...
├── Part-2.py                           # Code implementation for Part 2
...
├── submission_ood.csv                  # Part-1 submission CSV
├── submission_ood2.csv                 # Part-2 submission CSV
├── submission_ood3_resnet101.csv       # Part-3 best score submission CSV
